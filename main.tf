module "eks" {
  source = "github.com/getupcloud/terraform-modules//modules/eks?ref=v0.4.1"
...
module "flux" {
  source = "git@github.com:getupcloud/terraform-modules//modules/flux?ref=v0.4.1"
...
module "istio" {
  source = "git@github.com:getupcloud/terraform-modules//modules/istio?ref=v0.4.1"
