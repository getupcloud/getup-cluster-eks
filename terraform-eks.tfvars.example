...
# Type: ${string}
# Default: "ON_DEMAND"
fallback_node_group_capacity_type = "SPOT"
...
# Type: ${list(string)}
# Default: []
#aws_auth_user_arns = ["arn:aws:iam::XXXXXXXXXXXX:user/admin", "arn:aws:iam::XXXXXXXXXXXX:user/john"]
...
aws_auth_users = [
  {
    userarn  = "arn:aws:iam::XXXXXXXXXXXX:user/alice"
    username = "alice"
...
# Type: ${list(string)}
# Default: []
aws_auth_role_arns = ["arn:aws:iam::XXXXXXXXXXXX:role/getupcloud"]
...
aws_auth_roles = [
  {
    rolearn  = "arn:aws:iam::XXXXXXXXXXXX:role/CustomRole_EKSDeveloper"
    username = "CustomRole_EKSDeveloper"
    groups   = ["system:masters"]
  }
]
